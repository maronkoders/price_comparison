  ...
  <div>
    ...
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <modal ref="cityPad" title="ADD MANUFACTURER" no-close-on-backdrop no-close-on-esc hide-cancel  :hide-ok="true" @cancel="$refs.cityPad.hide()" centered>
        ...
        <modal ref="editcityPad" title="EDIT MANUFACTURER" no-close-on-backdrop no-close-on-esc hide-cancel  :hide-ok="true" @cancel="$refs.editcityPad.hide()" centered>
                <form>
                    <div class="row">
                      <div class="col-md-12 pr-1">
                        <div class="form-group">
                          <label> Name</label>
                          <input type="text" class="form-control" v-model="manufacturer_name" />
                        </div>
                      </div>
...
export default {
  ...
  closeThemodal:function()
  {
    ...
    { 
      this.$store.commit('putManufacturerData', record);
    ...
    getStatusName(rowObj)
    {
         return rowObj.is_active ? "ACTIVE" :"INACTIVE";
    },
    ...
    deleteRecord(record)
    {
        this.isLoading =true
        axios
        .delete("api/deleteManufacturer?id="+ record.id+"&data_name="+this.data_name)
        .then((response) => {
          this.isLoading =false
    ...
    {
        this.manufacturer_name = record.name;
        this.id = record.id;
    ...
    editIndustry(event)
    {
        ...
        this.editText =""
            ...
            axios
            .put("api/updateManufacturer", data)
            .then((response) => {
            this.saving =false;
            this.editText ="Edit"
            if(response.data.status == 200)
     ...
     addIndustry(event)
    {
            ...
            axios
            .post("api/newManufacturer?data_name=manufacturer" , data)
            .then((response) => {
            this.saving =false;
            this.text ="Save"
    ...
    loadItems() {
      this.isLoading =true
      axios
        .get("api/getManufacturer?data_name="+this.data_name)
        .then((response) => {
           this.isLoading =false
          if (response.data.status === 200) {
      ...
      axios
        ...
        .then((response) => {
          if (response.data.status === 200) {
            ...
            this.products_ = response.data["products"];
          } else {
