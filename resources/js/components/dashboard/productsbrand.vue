  ...
  <div>
    ...
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <modal ref="industryPad" title="ADD BRAND"  :hide-ok="true" @cancel="$refs.industryPad.hide()" centered>
        ...
        <modal ref="editIndustryPad" title="EDIT BRAND"  :hide-ok="true" @cancel="$refs.editIndustryPad.hide()" centered>
                <form>
                    <div class="row">
                      <div class="col-md-12 pr-1">
                        <div class="form-group">
...
export default {
  ...
  methods:{
    ...
    deleteRecord(record)
    {
         this.isLoading =true
        axios
        .delete("api/deleteBrand?id="+ record.id+"&data_name="+this.data_name)
        .then((response) => {
     ...
     addIndustry(event)
    {
            ...
            axios
            .post("api/newBrand?data_name=category" , data)
            .then((response) => {
            this.saving =false;
            this.text ="Save"
    ...
    loadItems() {
      this.isLoading =true
      axios
        .get("api/getBrands?data_name="+this.data_name)
        .then((response) => {
           this.isLoading =false
          if (response.data.status === 200) {
