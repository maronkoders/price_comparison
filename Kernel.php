...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\shop_cors::class,
    ];
    ...
    protected $routeMiddleware = [
      ...
      'Customer' => \App\Http\Middleware\RedirectIfNotCustomer::class,
        ...
        'view_bulk_order' => \App\Http\Middleware\order\view_bulk_order::class,
        ...
        'cors' => \App\Http\Middleware\shop_cors::class,
        ...
        'add_collection_point' => \App\Http\Middleware\collection_point\add_collection_point::class,
        'edit_collection_point' => \App\Http\Middleware\collection_point\edit_collection_point::class,
        'view_collection_point' => \App\Http\Middleware\collection_point\view_collection_point::class,
        'delete_collection_point' => \App\Http\Middleware\collection_point\delete_collection_point::class,
